module RMTools
  module String
    module Splitters
      ...
      # Same as #split, but without :reject_splitter option keeps splitters
      # on the *left side* of parts
      ...
      # Same as #sharp_split, but without :reject_splitter option keeps splitters
      # on the *right side* of parts
      ...
      # slice a string to pieces of length +len+ or less in case of last piece
      def div(len)
